...
function animate() {
    ...
    // Immersion follows workingState with a slower, asymmetric ease:
    // ~5s to fully swallow (only sustained work gets there), ~10s to
    // drift back out after completion. Short requests barely lean in.
    const immersionTarget = workingState * IMMERSION_CAP;
